...
#              '../logs/workflow_scheduling-v2/20220318164126402151',
#              '../logs/workflow_scheduling-v2/20220309165550153085']

log_paths = ['../logs/workflow_scheduling-v2/20220309165550150991',
             '../logs/workflow_scheduling-v2/20220318164126402151',
             '../logs/workflow_scheduling-v2/20220321174939747111']
name_list = ['ES-gamma-3.5-lr-0.001-sigma-0.01', 'ES-gamma-3.5-lr-0.01-sigma-0.05', 'ES-gamma-3.5-lr-0.001-sigma-0.1']

all_csv_files = []
EXT = "testing_record.csv"
...
def draw_figs(data):
    ...
    sns.lineplot(data=data, x='generation', y='rewards', hue='method', palette=sns.color_palette("Set1", 3))
    plt.ylim(0, 200)
    # plt.show()
    plt.savefig(os.path.join(fig_path, 'testing settings'))
